...
rule featurecount:
    ...
    """
    output:
        cnt = "results/annotation/{assembler}/{filter_source}/{sample_id}/featureCounts/fc.tsv",
        summary = "results/annotation/{assembler}/{filter_source}/{sample_id}/featureCounts/fc.tsv.summary"
    input:
...
rule normalize_featurecount:
    """
    Generates raw and TPM normalized count tables
    """
    output:
        "results/annotation/{assembler}/{filter_source}/{sample_id}/featureCounts/fc.tpm.tsv",
        "results/annotation/{assembler}/{filter_source}/{sample_id}/featureCounts/fc.raw.tsv"
    input:
        fc="results/annotation/{assembler}/{filter_source}/{sample_id}/featureCounts/fc.tsv",
...
rule parse_eggnog:
    ...
    """
    output:
        expand("results/annotation/{{assembler}}/{{filter_source}}/{{sample_id}}/eggNOG/{db}.parsed.tsv",
...
rule quantify_eggnog:
    ...
    input:
        abundance = "results/annotation/{assembler}/{filter_source}/{sample_id}/featureCounts/fc.{fc}.tsv",
...
rule sum_taxonomy:
    ...
    input:
        ...
        tpm = "results/annotation/{assembler}/{filter_source}/{sample_id}/featureCounts/fc.tpm.tsv",
        raw = "results/annotation/{assembler}/{filter_source}/{sample_id}/featureCounts/fc.raw.tsv"
    run:
        ranks = ["superkingdom", "kingdom", "phylum", "class", "order", "family", "genus", "species"]
